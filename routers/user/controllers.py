...
from .services import bcrypt_context, authenticate_user, create_access_token, list_serial, user_dependency, create_refresh_token, token_expired, decode_token, check_if_user_already_exits
from .validators import CreateUserRequest, UpdateUserRequest, Token, RefreshTokenRequest, LoginRequest, UserType
...
async def create_admin(create_user_request: CreateUserRequest, current_user: user_dependency):
  ...
  return create_user_request.model_dump(exclude={"password"})
